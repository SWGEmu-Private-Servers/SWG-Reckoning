...
public:
	enum {
		...
		FS_SURVEY_SPECIAL_RESOURCE_03     = 149,
		FS_SURVEY_SPECIAL_RESOURCE_04     = 150,
		FS_SURVEY_SPECIAL_RESOURCE_05     = 151,
		FS_SURVEY_SPECIAL_RESOURCE_06     = 152,
		FS_SURVEY_SPECIAL_RESOURCE_07     = 153,
		FS_SURVEY_SPECIAL_RESOURCE_08     = 154,
		FS_SURVEY_SPECIAL_RESOURCE_09     = 155,
		FS_SURVEY_SPECIAL_RESOURCE_10     = 156,
		FS_SURVEY_SPECIAL_RESOURCE_11     = 157,
		FS_SURVEY_SPECIAL_RESOURCE_12     = 158,
		FS_SURVEY_SPECIAL_RESOURCE_13     = 159,
		FS_SURVEY_SPECIAL_RESOURCE_14     = 160,
		FS_SURVEY_SPECIAL_RESOURCE_15     = 161,
		FS_SURVEY_SPECIAL_RESOURCE_16     = 162,
		FS_DATH_wOMAN_TALK                = 163,
		FS_PATROL_QUEST_START             = 164,
		FS_REFLEX_RESCUE_QUEST_07         = 165,
		FS_SURVEY_PHASE2_REwARD           = 166,
		FS_SURVEY_PHASE3_REwARD           = 167,
		FS_DEFEND_SET_FACTION_02          = 168,
		LOOT_DATAPAD_1                    = 169,
		GOT_DATAPAD                       = 170,
		FS_PHASE_2_CRAFT_DEFENSES_01      = 171,
		FS_PHASE_3_CRAFT_SHIELDS_01       = 172,
		FS_PHASE_2_CRAFT_DEFENSES_MAIN    = 173,
		FS_PHASE_3_CRAFT_SHIELDS_MAIN     = 174,
		LOOT_DATAPAD_2                    = 175,
		GOT_DATAPAD_2                     = 176,
		FS_CS_QUEST_FAILED_ESCORT         = 177,
		FS_PATROL_QUEST_FINISH            = 178,
		FS_MEDIC_PUZZLE_QUEST_FINISH      = 179,
		FS_COMBAT_HEALING_FINISH          = 180,
		FS_COMBAT_REwARD_PHASE2           = 181,
		FS_REFLEX_REwARD_PHASE3           = 182,
		FS_DEFEND_wAIT_01                 = 183,
		FS_DEFEND_wAIT_02                 = 184,
		FS_CRAFTING4_QUEST_FINISH         = 185,
		FS_CRAFT_PUZZLE_QUEST_04          = 186,
		CS_QUEST_DONE_NOTIFYONLY          = 187
};
