...
includeFile("items/named_crystals/force_crystal_baass_wisdom.lua")
includeFile("items/named_crystals/force_crystal_banes_heart.lua")
includeFile("items/named_crystals/force_crystal_bnars_sacrifice.lua")
includeFile("items/named_crystals/force_crystal_bondaras_folly.lua")
includeFile("items/named_crystals/force_crystal_dawn_of_dagobah.lua")
includeFile("items/named_crystals/force_crystal_gallias_intuition.lua")
includeFile("items/named_crystals/force_crystal_horns_future.lua")
includeFile("items/named_crystals/force_crystal_kenobis_legacy.lua")
includeFile("items/named_crystals/force_crystal_kits_ferocity.lua")
includeFile("items/named_crystals/force_crystal_kuns_blood.lua")
includeFile("items/named_crystals/force_crystal_kylos_fury.lua")
includeFile("items/named_crystals/force_crystal_mauls_vengence.lua")
includeFile("items/named_crystals/force_crystal_mundis_response.lua")
includeFile("items/named_crystals/force_crystal_prowess_of_plo_koon.lua")
includeFile("items/named_crystals/force_crystal_qui_gons_devotion.lua")
includeFile("items/named_crystals/force_crystal_quintessence_of_the_force.lua")
includeFile("items/named_crystals/force_crystal_strength_of_luminaria.lua")
includeFile("items/named_crystals/force_crystal_sunriders_destiny.lua")
includeFile("items/named_crystals/force_crystal_ulics_redemption.lua")
includeFile("items/named_crystals/force_crystal_windus_guile.lua")
